...
int main() {
    string inputPath = "/home/hasnain-akhtar/Documents/A3/c2.jpg";
    ...
    string kernelSource = readKernelFile("convolution.cl");
    ...
    if (maxVal > minVal) {
        ...
        cerr << "Error: Output image has uniform values, check kernel!" << endl;
    }
    ...
    cout << "Processed image saved as " << outputPath << endl;
